...
namespace App16_Authorization.Controllers
{
    ...
    public class ColorsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,ColorName,ColorCode")] Color color)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,ColorName,ColorCode")] Color color)
        {
            if (id != color.Id)
            {
                return NotFound();
