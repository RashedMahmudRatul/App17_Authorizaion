...
namespace App16_Authorization.Controllers
{
    ...
    public class SizesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,SizeName,SizeSymbol")] Size size)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,SizeName,SizeSymbol")] Size size)
        {
            if (id != size.Id)
            {
                return NotFound();
